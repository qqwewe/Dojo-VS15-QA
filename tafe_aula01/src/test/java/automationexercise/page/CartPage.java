...
public class CartPage extends BasePage{
    ...
    private static final By TEXT_SUCCSESS_ADD_CART = By.cssSelector("div.layer_cart_product.col-xs-12.col-md-6 > h2");
    private static final By BUTTON_CHECKOUT = By.cssSelector("div.button-container > a");
    private static final By TEXT_SUCCSESS_CHECKOUT = By.cssSelector("#cart_title");
